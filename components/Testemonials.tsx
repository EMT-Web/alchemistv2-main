                        ...
                        <div className="testimony-wrap py-4">
                            ...
                            <span><a href="https://www.tripadvisor.com/ShowUserReviews-g293732-d18453425-r886097614-Escorted_Morocco_Tours-Casablanca_Casablanca_Settat.html" target={"_blank"}><span className="fa fa-tripadvisor mr-2"/></a>TripAdvisor User</span>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <Image className="user-img"  src="https://dynamic-media-cdn.tripadvisor.com/media/photo-f/01/2e/70/9e/avatar069.jpg?w=100&h=-1&s=1" alt="Mira I."  layout='fill' objectFit="cover" blurDataURL="https://dynamic-media-cdn.tripadvisor.com/media/photo-f/01/2e/70/9e/avatar069.jpg?w=100&h=-1&s=1" placeholder="blur" loading="lazy"/>
                                    </div>
                                    <div className="pl-3">
                ...
                <div className="item">
                        <div className="testimony-wrap py-4">
                            ...
                            <span><a href="https://www.tripadvisor.com/ShowUserReviews-g293732-d18453425-r883116835-Escorted_Morocco_Tours-Casablanca_Casablanca_Settat.html" target={"_blank"}><span className="fa fa-tripadvisor mr-2"/></a>TripAdvisor User</span>
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="user-img" >
                                    <Image className="user-img"  src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/22/57/36/5f/navigate41658583432.jpg?w=100&h=-1&s=1" alt="Varun R"  layout='fill' objectFit="cover" blurDataURL="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/22/57/36/5f/navigate41658583432.jpg?w=100&h=-1&s=1" placeholder="blur" loading="lazy"/>
                                    </div>
                                    <div className="pl-3">
                    ...
                    <div className="item">
                        <div className="testimony-wrap py-4">
                            ...
                            <span><a href="https://www.tripadvisor.com/Attraction_Review-g293732-d18453425-Reviews-Escorted_Morocco_Tours-Casablanca_Casablanca_Settat.html" target={"_blank"}><span className="fa fa-tripadvisor mr-2"/></a>TripAdvisor User</span>
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="user-img" >
                                    <Image className="user-img"  src="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/e6/ea/default-avatar-2020-54.jpg" alt="Varun R"  layout='fill' objectFit="cover" blurDataURL="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/e6/ea/default-avatar-2020-54.jpg" placeholder="blur" loading="lazy"/>
                                    </div>
                                    <div className="pl-3">
                    ...
                    <div className="item">
                        <div className="testimony-wrap py-4">
                            ...
                            <span><a href="https://www.tripadvisor.com/Attraction_Review-g293732-d18453425-Reviews-Escorted_Morocco_Tours-Casablanca_Casablanca_Settat.html" target={"_blank"}><span className="fa fa-tripadvisor mr-2"/></a>TripAdvisor User</span>
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="user-img" >
                                    <Image className="user-img"  src="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/f0/9f/default-avatar-2020-16.jpg" alt="Adventure228395"  layout='fill' objectFit="cover" blurDataURL="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/f0/9f/default-avatar-2020-16.jpg" placeholder="blur" loading="lazy"/>
                                    </div>
                                    <div className="pl-3">
                    ...
                    <div className="item">
                        <div className="testimony-wrap py-4">
                            ...
                            <span><a href="https://www.tripadvisor.com/Attraction_Review-g293732-d18453425-Reviews-Escorted_Morocco_Tours-Casablanca_Casablanca_Settat.html" target={"_blank"}><span className="fa fa-tripadvisor mr-2"/></a>TripAdvisor User</span>
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="user-img" >
                                    <Image className="user-img"  src="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/f3/e4/default-avatar-2020-30.jpg" alt="Renata"  layout='fill' objectFit="cover" blurDataURL="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/f3/e4/default-avatar-2020-30.jpg" placeholder="blur" loading="lazy"/>
                                    </div>
                                    <div className="pl-3">
                    ...
                    <div className="item">
                        <div className="testimony-wrap py-4">
                            ...
                            <span><a href="https://www.tripadvisor.com/Attraction_Review-g293732-d18453425-Reviews-Escorted_Morocco_Tours-Casablanca_Casablanca_Settat.html" target={"_blank"}><span className="fa fa-tripadvisor mr-2"/></a>TripAdvisor User</span>
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="user-img" >
                                    <Image className="user-img"  src="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/df/99/default-avatar-2020-40.jpg" alt="Elena G"  layout='fill' objectFit="cover" blurDataURL="https://media-cdn.tripadvisor.com/media/photo-o/1a/f6/df/99/default-avatar-2020-40.jpg" placeholder="blur" loading="lazy"/>
                                    </div>
                                    <div className="pl-3">
