        ...
        <div className="row">
                ...
                <div className="project-wrap">
                    ...
                    <div className="text p-4">
                        ...
                        <p className="location my-3"><span className="fa fa-map-marker mr-2"> via</span>{tour.destinations?.slice(1).filter((d:any)=>d?.slug?.current).map((d:any, index:any)=>  <a key={index} href={`/destinations/${d.slug.current}`} target="_blank">{d.city}, </a>)}...</p>
                        <hr />
                        <ul>
